...
namespace Fulbo.UI
{
    public class MyTeamSelector : CascadeList
    {
        ...
        public void Start()
        {
            ...
            if(!Data.Instance.fixtureManager.isFixtureHappening && (Data.Instance.settings.mainSettings.isArcade || !Data.Instance.tournamentsData.IsTournament()))
            {
